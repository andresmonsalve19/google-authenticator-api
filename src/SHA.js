...
(function (G) {
    function t(e, a, d) {
        var g = 0, c = [], b = 0, f, k, l, h, m, w, n, y, p = !1, q = [], t = [], v, u = !1, d = d || {}, f = d.encoding || "UTF8", v = d.numRounds || 1, l = z(a, f);
        ...
        this.setHMACKey = function (a, b, c) {
            ...
            if (d < a / 8) {
                for (b = n(b, a, 0, x(e), h); b.length <= c; ) {
                    b.push(0);
                }
                b[c] &= 4294967040;
            } else if (d > a / 8) {
        ...
        this.update = function (a) {
            var d, e, f, h = 0, n = m >>> 5, d = l(a, c, b), a = d.binLen, e = d.value, d = a >>> 5;
    ...
    function J(e, a, d) {
        var g = e.length, c, b, f, k, l, a = a || [0], d = d || 0, l = d >>> 3;
    ...
    function K(e, a, d) {
        var g = [], c, b, f, k, g = a || [0], d = d || 0, b = d >>> 3;
    ...
    function L(e, a, d) {
        var g = [], c = 0, b, f, k, l, h, m, g = a || [0], d = d || 0, a = d >>> 3;
        ...
        for (f = 0; f < e.length; f += 4) {
            ...
            for (k = l = 0; k < h.length; k += 1) {
                b = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(h[k]);
                l |= b << (18 - 6 * k);
            }
    ...
    function D(e, a, d) {
        ...
        for (b = 0; b < c; b += 3) 
            for (
                f = b + 1 < c ? e[(b + 1) >>> 2] : 0,
                k = b + 2 < c ? e[(b + 2) >>> 2] : 0,
                k = (((e[b >>> 2] >>> (8 * (3 - (b % 4)))) & 255) << 16) | (((f >>> (8 * (3 - ((b + 1) % 4)))) & 255) << 8) | ((k >>> (8 * (3 - ((b + 2) % 4)))) & 255),
                f = 0; 
                4 > f; 
                f += 1
            )

            8 * b + 6 * f <= a ? (g += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt((k >>> (6 * (3 - f))) & 63)) : (g += d.b64Pad);
    ...
    function z(e, a) {
        ...
        switch (e) {
            ...
            case "TEXT":
                d = function (d, c, b) {
                    var f = [], e = [], l = 0, h, m, q, n, p, f = c || [0], c = b || 0, q = c >>> 3;
                                ...
                                128 > b
                                    ...
                                    : 2048 > b 
                                        ...
                                        : 55296 > b || 57344 <= b 
                                            ...
                                            : ((h += 1), (b = 65536 + (((b & 1023) << 10) | (d.charCodeAt(h) & 1023))), e.push(240 | (b >>> 18), 128 | ((b >>> 12) & 63), 128 | ((b >>> 6) & 63), 128 | (b & 63))),
                                m = 0;
                                m < e.length;
                                m += 1
                            ) 
    ...
    function A(e, a) {
        var d = [], g, c, b, f, k, l, h, g = a[0], c = a[1], b = a[2], f = a[3], k = a[4];
        for (h = 0; 80 > h; h += 1)
            (d[h] =
                16 > h
                    ? e[h]
                    : p(d[h - 3] ^ d[h - 8] ^ d[h - 14] ^ d[h - 16], 1)),
                (l =
                    20 > h
